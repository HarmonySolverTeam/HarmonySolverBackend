...
//  )
  ...
  for ((name, exercise) <- (majorExercises ++ minorExercises ++ majorWithAlterationsExercises ++ minorWithAlterationsExercises)) {
    ...
    exerciseNumber += 1
    println(s"Exercise $exerciseNumber/10 processed")
  }
}

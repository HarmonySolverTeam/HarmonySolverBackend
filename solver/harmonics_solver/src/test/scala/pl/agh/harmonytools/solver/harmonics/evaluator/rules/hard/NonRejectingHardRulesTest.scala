...
import pl.agh.harmonytools.solver.harmonics.evaluator.PrologChordRulesChecker
import pl.agh.harmonytools.utils.TestUtils

class NonRejectingHardRulesTest extends FunSuite with Matchers with TestUtils {
  ...
  test("Crossing Voices test") {
    ...
    val notRejectingEvaluator = PrologChordRulesChecker()
    notRejectingEvaluator.evaluateHardRules(Connection(ch1, ch1)) shouldBe true
    notRejectingEvaluator.evaluateHardRules(Connection(ch2, ch1)) shouldBe true
    notRejectingEvaluator.evaluateHardRules(Connection(ch3, ch1)) shouldBe true
    notRejectingEvaluator.evaluateHardRules(Connection(ch4, ch1)) shouldBe true
    notRejectingEvaluator.evaluateHardRules(Connection(ch5, ch1)) shouldBe true
    notRejectingEvaluator.evaluateHardRules(Connection(ch6, ch1)) shouldBe true
    notRejectingEvaluator.evaluateHardRules(Connection(ch7, ch2)) shouldBe true
  }
  ...
  test("Forbidden Jump test") {
    ...
    val notRejectingEvaluator = PrologChordRulesChecker()
    notRejectingEvaluator.evaluateHardRules(Connection(ch2, ch1)) shouldBe true
    notRejectingEvaluator.evaluateHardRules(Connection(ch1up, ch1)) shouldBe true
    notRejectingEvaluator.evaluateHardRules(Connection(ch2up, ch1)) shouldBe true
    notRejectingEvaluator.evaluateHardRules(Connection(ch3up, ch1)) shouldBe true
    notRejectingEvaluator.evaluateHardRules(Connection(ch4up, ch1)) shouldBe true
    notRejectingEvaluator.evaluateHardRules(Connection(ch5up, ch1)) shouldBe true
    notRejectingEvaluator.evaluateHardRules(Connection(ch6up, ch1)) shouldBe true
    notRejectingEvaluator.evaluateHardRules(Connection(ch1down, ch1)) shouldBe true
    notRejectingEvaluator.evaluateHardRules(Connection(ch2down, ch1)) shouldBe true
    notRejectingEvaluator.evaluateHardRules(Connection(ch3down, ch1)) shouldBe true
    notRejectingEvaluator.evaluateHardRules(Connection(ch4down, ch1)) shouldBe true
    notRejectingEvaluator.evaluateHardRules(Connection(ch5down, ch1)) shouldBe true
    notRejectingEvaluator.evaluateHardRules(Connection(ch6down, ch1)) shouldBe true
  }
  ...
  test("False Relation test") {
    ...
    val notRejectingEvaluator = PrologChordRulesChecker()
    notRejectingEvaluator.evaluateHardRules(Connection(ch2, ch1)) shouldBe true
    notRejectingEvaluator.evaluateHardRules(Connection(ch4, ch3)) shouldBe true
  }
  ...
  test("D -> S Connection test") {
    ...
    val notRejectingEvaluator = PrologChordRulesChecker()
    notRejectingEvaluator.evaluateHardRules(Connection(ch2, ch1)) shouldBe true
    notRejectingEvaluator.evaluateHardRules(Connection(ch1, ch2)) shouldBe true
  }

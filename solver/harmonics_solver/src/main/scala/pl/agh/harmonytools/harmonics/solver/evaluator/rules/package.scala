...
import pl.agh.harmonytools.harmonics.solver.evaluator.rules.hard.ForbiddenJumpRule
import pl.agh.harmonytools.harmonics.solver.evaluator.rules.subrules.{SameFunctionRule, SpecificFunctionConnectionRule}

...
import pl.agh.harmonytools.algorithm.evaluator.{Connection, ConnectionEvaluator, HardRule, RuledBasedConnectionEvaluator, SoftRule}
import pl.agh.harmonytools.model.chord.Chord
import pl.agh.harmonytools.solver.harmonics.evaluator.rules.hard.{CrossingVoicesRule, FalseRelationRule, ForbiddenJumpRule, HiddenOctavesRule, ParallelFifthsRule, ParallelOctavesRule}

object BasicHardRulesChecker extends RuledBasedConnectionEvaluator[Chord] {

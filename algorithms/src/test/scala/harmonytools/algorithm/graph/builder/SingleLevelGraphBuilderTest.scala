package harmonytools.algorithm.graph.builder

import harmonytools.algorithm.graph.builders.SingleLevelGraphBuilder
import org.scalatest.{FunSuite, Matchers}
import harmonytools.algorithm.evaluator.{Connection, ConnectionEvaluator, HardRule, IRule, SoftRule}
import harmonytools.algorithm.generator.{GeneratorInput, LayerGenerator}
import harmonytools.algorithm.graph.node.{EmptyContent, NodeContent}

package harmonytools.algorithm.graph.builders

import harmonytools.algorithm.graph.DoubleLevelGraph
import harmonytools.error.UnexpectedInternalError
import harmonytools.algorithm.{LeafLayer, LeafNeighbourNode, LeafNode}
import harmonytools.algorithm.evaluator.{Connection, ConnectionEvaluator}
import harmonytools.algorithm.generator.{GeneratorInput, LayerGenerator}
import harmonytools.algorithm.graph.node.{Layer, NeighbourNode, Node, NodeContent}
